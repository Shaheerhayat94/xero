...
public class HomePage extends BasePage{
	...
	public void selectSalesForceChatter() {
		selectDropdown(driver,By.xpath("//select[@onchange='javascript:tabSetSelChange(this);']"), "Salesforce Chatter" );
		
	 }

	public void selectReportsTab() {
		selectDropdown(driver,By.xpath("//tbody/tr[1]/td[1]/select[1]"), "Reports" );
	...
	/*public void selectavlbltabreport () {
		Select selectReportTab = new Select(driver.findElement(By.id("duel_select_0")));
		selectReportTab.selectByValue("report");
	}*/
